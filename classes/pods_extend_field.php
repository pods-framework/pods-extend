<?php
/**
* Empty class ready to create a new Pods field type with.
* Don't forget to include this file and initialize the class!
*/

class pods_extend_field extends PodsField {
